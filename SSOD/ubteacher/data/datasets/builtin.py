...
#     ),
# }
_SPLITS_COCO_FORMAT["brats"] = {
    "brats21_cut_train_label": (
        "brats21/train_label",
        "brats21/annotations/instances_train_label.json",
    ),
    "brats21_cut_train_unlabel": (
        "brats21/train_unlabel", 
        "brats21/annotations/instances_train_unlabel.json",
    ),
}
