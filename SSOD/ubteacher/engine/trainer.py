...
class BaselineTrainer(DefaultTrainer):
    ...
    def resume_or_load(self, resume=True):
        ...
        if isinstance(self.model, DistributedDataParallel):
            ...
            # Different torch versions use different private sync APIs.
            try:
                if hasattr(self.model, "_sync_params_and_buffers"):
                    self.model._sync_params_and_buffers()
                elif hasattr(self.model, "_sync_module_states"):
                    self.model._sync_module_states()
            except Exception:
                pass
